...
const blocks: BlockDefinition[] = [
	...
	},
	{
        ...
        args: [
            new ValueInput("CONTENT", BlockType.String),
        ],
        shape: BlockShape.Floating,
		output: BlockType.String,
        inline: true,
    ...
    },
    {
        ...
        args: [
            new ValueInput("TEXT_CONTENT", BlockType.String)
        ],
    ...
    },
	{
        ...
        helpUrl: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String/Trim",
        code: (args) => {
    ...
    },
	{
		...
		placeholders: [
            new Placeholder(PlaceholderType.Block, "TEXT", "text", {CASE: "abc"})
        ],
        shape: BlockShape.Floating,
        output: BlockType.String,
        inline: true,
	...
	},
	{
		...
		placeholders: [
			new Placeholder(PlaceholderType.Block, "TEXT", "text", {TEXT: ""})
		],
		shape: BlockShape.Floating,
	...
	},
	{
        ...
        helpUrl: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String/length",
        code: (args) => {
    ...
    },
    {
		...
		placeholders: [
            new Placeholder(PlaceholderType.Block, "TEXT", "text", {TEXT: "abc123"})
        ],
        shape: BlockShape.Floating,
        output: BlockType.Boolean,
        inline: true,
